...
#
# This is copied and modified from hostap/tests/hwsim
#
...
[ "$RUNNING" = "yes" ] && echo "Terminating hostapd and wpa_supplicant"
...
if grep -q scm80211_hwsim /proc/modules 2>/dev/null ; then
    echo "Unloading modules"
	sudo rmmod scm80211
	sudo rmmod scm80211_hwsim
    sudo rmmod mac80211
    sudo rmmod scm80211-cfg80211
    sudo rmmod scm80211-lib80211_crypt_ccmp
    sudo rmmod scm80211-lib80211_crypt_tkip
    sudo rmmod scm80211-lib80211_crypt_wep
    sudo rmmod scm80211-lib80211
    sudo rmmod libarc4 

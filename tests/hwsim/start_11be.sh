...
if [ -f /proc/modules ]; then
    #sudo modprobe cfg80211 dyndbg=+p
    #sudo modprobe mac80211 dyndbg=+p
    #sudo insmod /home/shikew/project/taihu/linux/mac80211/mac80211.ko
    sudo insmod /lib/modules/`uname -r`/kernel/lib/crypto/libarc4.ko
    sudo insmod /home/shikew/project/taihu/linux/wireless/scm80211-lib80211.ko
    sudo insmod /home/shikew/project/taihu/linux/wireless/scm80211-cfg80211.ko
    sudo insmod /home/shikew/project/taihu/linux/wireless/scm80211-lib80211_crypt_ccmp.ko
    sudo insmod /home/shikew/project/taihu/linux/wireless/scm80211-lib80211_crypt_tkip.ko
    sudo insmod /home/shikew/project/taihu/linux/wireless/scm80211-lib80211_crypt_wep.ko
    sudo insmod /home/shikew/project/taihu/linux/mac80211/mac80211.ko
    sudo insmod /home/shikew/project/jinjihu-ax/hwsim/scm80211_hwsim.ko radios=7 mac_log_level=7 dyndbg=+p
    sudo insmod /home/shikew/project/jinjihu-ax/mac80211/scm80211.ko rf=hwsim-0 dyndbg=+p
fi

# Setup dynamic debug
echo "Setting dynamic debug"

if [ -d $DIR/dyndbg.d ]; then
    echo "Setting up dynamic debug"
    for f in $DIR/dyndbg.d/*; do sudo $f; done
    sleep 1
fi

echo "Bringing up monitor interface hwsim0"
...
echo -n "Starting wpa_supplicant with "
for i in 0 1 2; do
    DBUSARG=""
